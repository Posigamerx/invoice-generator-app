...
import { initialInvoiceData } from '@/lib/constant';
...
export function InvoiceProvider({children}: {children: ReactNode}){
    ...
    return (<InvoiceContext.Provider value={{invoice, updateInvoice, addItem, removeItem, updateItem}}>
        {children}
...
export function useInvoice() {
    ...
    if (context === undefined ){
        throw new Error("useInvoice must be use within an InvoiceProviders");
    }
    return context
}